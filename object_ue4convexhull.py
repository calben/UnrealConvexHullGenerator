#
# This edition of the plugin has been modified by Calem Bendell
# to produce convex collision hulls for Unreal Engine 4 with less
# effort.
#
...
#
# NOTE: requires/calls Khaled Mamou's testVHACD executable found here: https://github.com/kmammou/v-hacd
#

bl_info = {
    'name': 'UE4-Convex-Hull',
    'description': 'Hierarchical Approximate Convex Decomposition for Unreal Engine 4 Collisions',
    'author': 'Calem Bendell',
    'version': (0, 1),
    'blender': (2, 78, 0),
    'location': '3D View, Tools tab -> UE4-Convex-Hull, in Object mode',
    'warning': "Requires Khaled Mamou's V-HACD v2.0 textVHACD executable: (see documentation)",
    'wiki_url': 'https://github.com/calben/UnrealConvexHullGenerator',
    'category': 'Object',
}
...
class VHACD(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        for ob in selected:
            ...
            print('\nExporting mesh for UE4 Convex Hull Generator: {}...'.format(off_filename))
            ...
            print('Running UE4 Convex Hull Generator...\n{}\n'.format(cmd_line))
            ...
            for hull in imported:
                ...
                hull.name = "UCX_" + ob.name + "_" + ("%03d" % (counter,))
    ...
    def draw(self, context):
        ...
        layout.separator()
        col = layout.column()
        col.label('UE4 Convex Hull Generator Parameters:')
...
class VIEW3D_PT_tools_vhacd(bpy.types.Panel):
    ...
    bl_category = 'Tools'
    bl_label = 'UE4 Convex Hull Generator'
    ...
    def draw(self, context):
        ...
        col.operator('object.vhacd', text='UE4 Convex Hull Generator')
